...
def namespaces():
    ...
    data['namespaces'] = all_namespaces[start_index:end_index]
...
def pods():
    ...
    inventory['pods'] = all_pods[start_index:end_index]
...
def storage():
    ...
    all_storage_items = inventory.get(
        'storage_items',
        [],
    )
    ...
    inventory['storage_items'] = all_storage_items[start_index:end_index]
